...
import ItemSpawnAttempt from './ItemSpawnAttempt.js'; // Import your script here
import PacketAcknowledgementWarning from './PacketAcknowledgementWarning.js'; // Import your PacketAcknowledgementWarning script here
...
export default class SquadLogParser extends LogParser {
  ...
  getRules() {
    return [
      ...
      PacketAcknowledgementWarning // Add PacketAcknowledgementWarning here
    ];
  }
}
